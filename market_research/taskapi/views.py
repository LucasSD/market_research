...
class TileViewSet(viewsets.ModelViewSet):
    """New tiles are created from the tile list. Tiles can be read, updated and deleted by following
...
class TaskViewSet(viewsets.ModelViewSet):
    """New tasks are created from the task list. Tasks can be read, updated and deleted by following
